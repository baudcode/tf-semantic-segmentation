...
def get_preprocess_fn(size, is_training=True):
...
def prepare_dataset(dataset, batch_size, num_threads=8, shuffle_buffer_size=4000, buffer_size=1000, repeat=0, take=0, skip=0, num_workers=1, worker_index=0):
