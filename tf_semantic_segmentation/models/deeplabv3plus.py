# -*- coding: utf-8 -*-
# https://raw.githubusercontent.com/bonlime/keras-deeplab-v3-plus/master/model.py
...
from tensorflow.keras.layers import Input, Lambda, Activation, \
    Concatenate, Add, Dropout, BatchNormalization, Conv2D, \
    Conv2D, DepthwiseConv2D, ZeroPadding2D, GlobalAveragePooling2D
...
if __name__ == "__main__":
    model = deeplabv3_plus_xception()
    model.summary()

    K.clear_session()

    model = deeplabv3_plus_mobile()
    model.summary()
